        ...
        <div class="page-content"> 
            ...
            <div class="content">  
                <div class="page-title">	
                    <h4 class="semi-bold">Feedback from students.. </h4>		
                </div>
                <div id="container">
                                    ...
                                    <div class="span12">
                                        <div class="grid simple ">
                                            <div class="grid-title">
                                                <h4 style="color: #f65314;">Student <span class="semi-bold">Feedback</span></h4>
                                            ...
                                            <div class="grid-body ">
                                                <table class="table table-condensed" id="example">
                                                    ...
                                                    <tbody>
                                                        <?php require './WebServices/get_feedback.php'; ?>
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
