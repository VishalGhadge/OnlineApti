...
<body class="">
    ...
    <div class="page-container row-fluid"> 
        ...
        <div class="page-content"> 
            ...
            <div class="content">  
                <div class="page-title">
                    <div class="row-fluid">
                        ...
                        <div class="span4">
                            <a href="set_paper_3.php">
                                <i style="color: #2aa198; margin-left: 90%" class="icon-chevron-sign-right"></i>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div id="container">
                <?php include './WebServices/get_Question_2.php'; ?>
            </div>
            <div class="content">  
                <div class="page-title">
                    <div class="row-fluid">
